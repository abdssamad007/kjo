...
/** Facebook Canvas URL: */
$canvasPage = 'http://apps.facebook.com/abdssamad/'; // This URL should end with a slash (/).
...
$invitecontent='Check out this great fun game - abdssamad - I think you will love it.';
